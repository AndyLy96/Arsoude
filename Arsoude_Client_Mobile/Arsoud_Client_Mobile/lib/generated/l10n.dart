...
class S {
  ...
  /// `Notification for Hike Types`
  String get notifSettingsTypes {
    return Intl.message(
      'Notification for Hike Types',
      name: 'notifSettingsTypes',
      desc: '',
      args: [],
    );
  }

  /// `Notification for Distance`
  String get notifSettingsDistance {
    return Intl.message(
      'Notification for Distance',
      name: 'notifSettingsDistance',
      desc: '',
      args: [],
    );
  }
