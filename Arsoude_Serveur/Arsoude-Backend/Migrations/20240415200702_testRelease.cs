...
{
    public partial class testRelease : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTurnedOn = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotificationSettings_TrailUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "TrailUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "11111111-1111-1111-1111-111111111113", "3ef86f99-8a7b-47f3-83d9-9fb5a2e67140", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "11111111-1111-1111-1111-111111111111", 0, "39f9bf86-219d-46c2-8555-0b61e4a91a2e", "admin@admin.com", true, false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAEDfK0eF/x7LDWtHYjbfW6w+U3j6pOcWxFyWNnbNQ1FZrag/pu3eb7COHopk5ZoTRvA==", null, false, "81aaed0d-e096-4e09-84a6-75801d9e2913", false, "admin@admin.com" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "11111111-1111-1111-1111-111111111112", 0, "089675c7-1bba-4127-8ce8-43279a564fea", "user@user.com", true, false, null, "USER@USER.COM", "USER@USER.COM", "AQAAAAEAACcQAAAAEPvyZu6JiubvZ/4qzBQLcmWRrJqGMHLKoHa8MWOdPgbEPIMC63PpzLuLOjvRM3JJGA==", null, false, "8493e507-32e6-40cd-ad30-85889cfb8c9f", false, "user@user.com" });
            ...
            migrationBuilder.InsertData(
                table: "Trails",
                columns: new[] { "Id", "CreationDate", "Description", "Distance", "EndingCoordinatesId", "ImageUrl", "IsApproved", "Location", "Name", "OwnerId", "Rating", "StartingCoordinatesId", "TotalCompletions", "TotalRatings", "Type", "UserId", "isPublic" },
                values: new object[] { 2, null, "Une randonnée pittoresque à travers une forêt luxuriante où les oiseaux chantent et les rivières murmurent.", null, 2, "https://www.parksconservancy.org/sites/default/files/styles/basic/public/programs/A_PRSF_111020_MCu_020-2104x1440.jpg?itok=Cp14Z3ba", null, "Parc National de la Forêt Verte", "Sentier de la Forêt Enchantée", 1, null, 1, 0, 0, 0, null, true });
