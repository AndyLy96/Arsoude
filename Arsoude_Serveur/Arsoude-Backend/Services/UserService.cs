...
namespace Arsoude_Backend.Services
{
    public class UserService
    {
        ...
        public async Task ChangeSettings(NotificationSettings notifSettings, IdentityUser user)
        {
            ...
            if(userOfficial != null)
            {
                ...
                {
                    notifSettings.UserId = userOfficial.Id;
                    userOfficial.NotificationSettings = notifSettings;
                    return;
                }
